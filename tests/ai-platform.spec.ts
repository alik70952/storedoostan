...
test("قانون پسوند پلتفرم و ترتیب منابع کاور (واحدی، بدون اینترنت)", async () => {
  ...
  expect(ps5Steps).toEqual(["playstation", "wikipedia-exact", "igdb", "p30day", "downloadha", "steam-known", "steam-search", "rawg", "wikipedia", "duckduckgo", "bing", "google"]);
  const ps4Steps = cover.coverStepsFor("PS4");
  expect(ps4Steps).toEqual(["psstore-ps4", "playstation-ps4", "wikipedia-exact", "igdb", "p30day", "downloadha", "steam-known", "steam-search", "rawg", "wikipedia", "duckduckgo", "bing", "google"]);
