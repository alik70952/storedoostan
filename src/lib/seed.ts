...
const entries: SeedEntry[] = [
  ...
  { title: "God of War (2018)", titleFa: "خدای جنگ ۲۰۱۸ (کپی‌خور)", platform: "PS4", genre: "اکشن و ماجراجویی", cover: "https://cdn.cloudflare.steamstatic.com/steam/apps/1593500/library_600x900.jpg", description: "نسخه کپی‌خور خدای جنگ ۲۰۱۸ برای PS4 — آغاز سفر کریتوس و آترئوس در اساطیر نورس؛ برنده جایزه بهترین بازی سال با نصب آفلاین در فروشگاه دوستان." },
  { title: "Marvel's Spider-Man Remastered", titleFa: "اسپایدرمن (کپی‌خور)", platform: "PS4", genre: "اکشن و ماجراجویی", cover: "https://cdn.cloudflare.steamstatic.com/steam/apps/1817070/library_600x900.jpg", description: "نسخه کپی‌خور مرد عنکبوتی برای PS4 — تاب‌خوردن در آسمان نیویورک با گرافیک بهبودیافته؛ نصب آفلاین و اجرای تضمینی." },
  { title: "Horizon Zero Dawn", titleFa: "افق: سپیده‌دم صفر (کپی‌خور)", platform: "PS4", genre: "اکشن و ماجراجویی", cover: "https://cdn.cloudflare.steamstatic.com/steam/apps/1151640/library_600x900.jpg", description: "نسخه کپی‌خور هورایزن زیرو داون برای PS4 — دنیای پساآخرالزمانی با ماشین‌های وحشی؛ نصب آفلاین در فروشگاه دوستان." },
  { title: "The Last of Us Part II", titleFa: "آخرین بازمانده از ما ۲ (کپی‌خور)", platform: "PS4", genre: "اکشن و ماجراجویی", cover: "https://cdn.cloudflare.steamstatic.com/steam/apps/2531310/library_600x900.jpg", description: "نسخه کپی‌خور لست آو آس پارت ۲ برای PS4 — ادامه داستان تأثیرگذار الی؛ نصب آفلاین با تمام آپدیت‌ها." },
  ...
  { title: "EA SPORTS FC 25", titleFa: "فوتبال EA اسپورتس ۲۰۲۵ (کپی‌خور)", platform: "PS5", genre: "ورزشی", cover: "https://cdn.cloudflare.steamstatic.com/steam/apps/2669320/library_600x900.jpg", description: "نسخه کپی‌خور FC 25 برای PS5 — جدیدترین فوتبال EA با تیم‌های به‌روز و حالت آلتیمیت تیم؛ نصب آفلاین در فروشگاه دوستان." },
  { title: "FIFA 23", titleFa: "فیفا ۲۳ (کپی‌خور)", platform: "PS4", genre: "ورزشی", cover: "https://cdn.cloudflare.steamstatic.com/steam/apps/1811260/library_600x900.jpg", description: "نسخه کپی‌خور فیفا ۲۳ برای PS4 — آخرین فیفا با جام جهانی قطر و گیم‌پلی روان؛ نصب آفلاین." },
  { title: "Halo: The Master Chief Collection", titleFa: "هیلو: مجموعه مستر چیف", platform: "Xbox Offline", genre: "شوتر", cover: "", description: "مجموعه کامل حماسه مستر چیف؛ شش بازی افسانه‌ای شوتر اول‌شخص با داستان حماسی و نبردهای نفس‌گیر، ویژه اجرای آفلاین روی Xbox.", featured: true },
  { title: "Forza Horizon 5", titleFa: "فورتزا هورایزن ۵", platform: "Xbox Offline", genre: "مسابقه‌ای", cover: "", description: "بزرگ‌ترین فستیوال اتومبیل‌رانی جهان در مکزیک؛ صدها خودرو، آب‌وهوای پویا و جاده‌های بی‌پایان برای تجربه آفلاین روی Xbox.", featured: true },
  { title: "Gears 5", titleFa: "گیرز ۵", platform: "Xbox Offline", genre: "شوتر", cover: "", description: "حماسه کیت دیاز در برابر ازدحام لوکاست‌ها؛ کمپین داستانی عمیق و حالت فرار هیجانی، مناسب اجرای آفلاین." },
  { title: "Red Dead Redemption 2", titleFa: "رد دد ریدمپشن ۲", platform: "Xbox Offline", genre: "اکشن و ماجراجویی", cover: "", description: "غرب وحشی در اوج شکوه؛ داستان آرتور مورگان و باند داچ، با دنیایی زنده و جزئیات خیره‌کننده برای بازی آفلاین." },
  { title: "Starfield", titleFa: "استارفیلد", platform: "Xbox Offline", genre: "نقش‌آفرینی", cover: "", description: "ماجراجویی فضایی بتسدا میان هزاران سیاره؛ کاوش، تجارت و نبردهای فضایی در بزرگ‌ترین دنیای نقش‌آفرینی Xbox." },
  { title: "Sea of Thieves", titleFa: "دریای دزدان", platform: "Xbox Offline", genre: "اکشن و ماجراجویی", cover: "", description: "دزدان دریایی در دنیای باز اقیانوسی؛ گنج‌یابی، نبرد کشتی‌ها و ماجراجویی‌های جزیره‌ای برای اجرای آفلاین." }
];
